...
<!--        </ul>-->
        ...
        <el-menu :default-active="'1'" class="el-menu-demo" mode="horizontal" background-color="#545c64" text-color="#fff" router>
          <el-menu-item index="/front/carousel/a">首页</el-menu-item>
          <el-menu-item index="/front/carousel/b">
            视频播放
          </el-menu-item>
          ...
          <el-menu-item><a href="/front/order">订单管理</a></el-menu-item>
        </el-menu>
      </div>
      <div style="width: 200px">
        <div v-if="!user.username" style="text-align: right; padding-right: 30px">
          <el-button @click="this.$router.push('/login')">登录</el-button>
          <el-button @click="this.$router.push('/resport')">注册</el-button>
        </div>
        <div v-else>
          <el-dropdown style="width: 150px; cursor: pointer; text-align: right">
            <div style="display: inline-block">
              <img :src="user.avater" alt=""
                   style="width: 30px; border-radius: 100%; position: relative; top: 10px; right: 60px">
              <span>{{ user.username }}</span><i class="el-icon-arrow-down" style="margin-left: 5px"></i>
            </div>
            <el-dropdown-menu slot="dropdown" style="width: 100px; text-align: center">
              <el-dropdown-item style="font-size: 14px; padding: 5px 0">
                <router-link to="/front">返回首页</router-link>
              </el-dropdown-item>
              <el-dropdown-item style="font-size: 14px; padding: 5px 0">
                <router-link to="/front/people">个人信息管理</router-link>
              </el-dropdown-item>
              <el-dropdown-item style="font-size: 14px; padding: 5px 0">
